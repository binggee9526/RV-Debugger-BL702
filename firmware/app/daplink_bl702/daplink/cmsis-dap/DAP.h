...
#endif
#ifndef PIN_DELAY_SLOW
#if defined(__riscv) || defined(__CC_ARM)
/* Inline assembly delay loop — MUST NOT be a pure C empty loop because
 * #pragma GCC optimize("O3") in SW_DP.c would remove it as dead code,
 * collapsing the SWD clock to maximum speed and breaking communication. */
